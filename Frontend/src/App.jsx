...
const iconPaths = {
  ...
  interview: (
    <>
      ...
      <path d="M9 4.5V3h6v1.5M8.5 9h7M8.5 13h7M8.5 17H12" />
    </>
  ),
  target: (
    <>
  ...
  volumeOff: (
    <>
      <path d="M5 10v4h3l4 4V6l-4 4H5ZM16 10l5 5M21 10l-5 5" />
    </>
  ),
  mic: (
    <>
...
const suggestions = [
  {
    ...
    prompt: "Tell me about Mrinmoy",
  },
  {
    icon: "sparkles",
    label: "Core AI skills",
    prompt: "What are his main AI skills?",
  },
  {
    icon: "code",
    label: "Featured projects",
    prompt: "Explain his main projects",
  },
  {
    icon: "briefcase",
    label: "Experience",
    prompt: "What experience does he have?",
  },
  {
    icon: "file",
    label: "Resume",
    prompt: "Can I download his resume?",
  },
  {
    icon: "target",
    label: "Recruiter view",
    prompt: "Why should we hire this candidate?",
  },
];
...
function loadChats() {
  try {
    ...
    const valid =
      ...
      savedChats.length > 0 &&
      savedChats.every(
        (chat) => chat?.id && Array.isArray(chat.messages),
      );
  ...
  return (
    <div className="match-result">
      ...
      <div className="match-copy">
        ...
        <p>
          <b>Matched skills:</b>{" "}
          {result.matched_skills.join(", ") || "None identified"}
        </p>
        ...
        <p>
          <b>Strengths:</b>{" "}
          {result.strengths.join(", ") || "Not provided"}
        </p>
...
export default function App() {
  ...
  async function sendMessage(customQuestion) {
    ...
    try {
      ...
      if (!response.body) {
        throw new Error(
          "Streaming response was not received.",
        );
      }
      ...
      if (autoSpeak && completeAnswer) {
        speak(completeAnswer);
      }
    } catch (error) {
      const message =
  ...
  async function generateInterviewQuestions() {
    ...
    try {
      ...
      appendAssistant(
        `${result.role} Interview Questions\n\n${content}`,
      );
  ...
  async function analyzeMatch() {
    ...
    try {
      ...
      appendAssistant(result.verdict, {
        match: result,
      });
      ...
      >
        ...
        <div className="sidebar-scroll">
          <div className="sidebar-label">
            ...
            <span className="section-count">6 tools</span>
          </div>
          ...
          <div className="feature-tools">
            ...
            >
              ...
              <span className="tool-copy">
                <b>{text.upload}</b>
                <small>Switch the active profile</small>
              </span>

              <Icon name="chevron" size={15} />
            </button>

            <button onClick={() => setPanel("interview")}>
              <span className="tool-icon">
                <Icon name="interview" />
              </span>
              ...
              <span className="tool-copy">
                <b>{text.interview}</b>
                <small>Generate role-specific prompts</small>
              </span>
            ...
            <button onClick={() => setPanel("match")}>
              ...
              <span className="tool-copy">
                <b>{text.match}</b>
                <small>Compare resume and job</small>
              </span>

              <Icon name="chevron" size={15} />
            </button>

            <button onClick={() => setPanel("hire")}>
              <span className="tool-icon">
                <Icon name="sparkles" />
              </span>
              ...
              <span className="tool-copy">
                <b>{text.hire}</b>
                <small>Create a recruiter summary</small>
              </span>
            ...
            <button onClick={exportChatPdf}>
              ...
              <span className="tool-copy">
                <b>{text.export}</b>
                <small>Save this conversation</small>
              </span>
            ...
            >
              ...
              <span className="tool-copy">
                <b>Download resume</b>
                <small>Open the current PDF</small>
              </span>
        ...
        <div className="sidebar-footer">
          <div className="profile-links">
            <a
              href="https://www.linkedin.com/in/mrinmoykumarmaity/"
              target="_blank"
              rel="noreferrer"
            >
              LinkedIn
            ...
            <a
              href="https://github.com/mrinmoykumarmaity"
              target="_blank"
              rel="noreferrer"
            >
              GitHub
          ...
          <div className="online-status">
            ...
            <div>
              <strong>AI representative online</strong>
              <small>Grounded in the active resume</small>
            </div>
          </div>
        </div>
      </aside>
      ...
      <section className="chat-section">
        <header className="header">
          <div className="header-left">
            ...
            <div className="header-content">
              ...
              <h3>Mrinmoy&apos;s AI Representative</h3>

              <p>
                Resume-grounded answers for recruiters and
                hiring teams
              </p>
            </div>
          </div>
          ...
          <div className="header-actions">
            ...
            <button
              ...
              title="Automatically speak AI answers"
              aria-label="Toggle automatic speech"
            >
              <Icon
                name={autoSpeak ? "volumeOn" : "volumeOff"}
                size={17}
              />
            </button>
          ...
          {activeChat.messages.length === 0 ? (
            <section className="welcome">
              ...
              <p className="welcome-kicker">
                MEET YOUR CANDIDATE, FASTER
              </p>

              <h1>
                Ask anything about <span>Mrinmoy</span>
              </h1>

              <p className="welcome-copy">
                Explore verified skills, projects, experience
                and job-fit insights through an AI assistant
                grounded only in the active candidate resume.
              </p>
              ...
              {activeChat.messages.map((message) => (
                ...
                >
                  ...
                  <div className="message-body">
                    ...
                    >
                      {message.match ? (
                        <MatchResult result={message.match} />
                      ) : message.content?.includes(
                          RESUME_URL,
                        ) ? (
                        <>
                          <p>
                            The candidate&apos;s resume is ready
                            to view.
                          </p>
        ...
        <footer className="input-area">
          ...
          <p className="disclaimer">
            <Icon name="shield" size={12} />
            Responses are generated only from the active
          ...
          >
              ...
              <>
                <div className="modal-heading">
                  <div className="modal-icon">
                    <Icon name="interview" size={22} />
                  </div>

                  <div>
                    <span>INTERVIEW PREP</span>
                    <h2>{text.interview}</h2>
                  </div>
                </div>

                <p>
                  Create technical, project and behavioral
                  questions grounded in the active resume.
                </p>

                <label>{text.jobRole}</label>
            ...
            {panel === "match" && (
              <>
                ...
                <p>
                  Compare the active resume with a pasted job
                  description and identify evidence-backed
                  strengths and gaps.
                </p>
                ...
                <textarea
                  ...
                  placeholder={text.jobDescription}
                />
            ...
            {panel === "hire" && (
              <>
                ...
                <p>
                  Create an honest candidate summary. Add a job
                  description for a role-specific answer.
                </p>
                ...
                <textarea
                  ...
                  placeholder={`${text.jobDescription} (optional)`}
                />

                <button
                  className="modal-action"
                  disabled={isStreaming}
                  onClick={generateWhyHire}
                >
                  <Icon name="sparkles" size={16} />
                  {text.generate}
                </button>
